...
struct neat_ctx *neat_usrsctp_init_ctx(struct neat_ctx *ctx)
{
    ...
    neat_log(ctx, NEAT_LOG_DEBUG, "sctp4_fd=%d", ctx->sctp4_fd);
    ...
    neat_log(ctx, NEAT_LOG_DEBUG, "udpsctp4_fd=%d", ctx->udpsctp4_fd);
    ...
    neat_log(ctx, NEAT_LOG_DEBUG, "sctp6_fd=%d", ctx->sctp6_fd);
    if (ctx->sctp6_fd != -1) {
    ...
    neat_log(ctx, NEAT_LOG_DEBUG, "udpsctp6_fd=%d", ctx->udpsctp6_fd);
