...
tests_general.append([0, 0, workdir + 'tneat -v 2 -L -n 1024 -P ' + workdir + 'prop_tcp.json'])

if (platform.system() == "FreeBSD") or (platform.system() == "Linux"):
    tests_general.append([0, 0, workdir + 'client_http_get -v 2 -P ' + workdir + 'prop_tcp_security.json -p 443 www.fh-muenster.de'])
