...
tests_general.append([0, 0, workdir + 'tneat -L -n 1024 -P ' + workdir + 'prop_tcp.json localhost'])
...
if (platform.system() == "FreeBSD") or (platform.system() == "Linux"):
    ...
    tests_general.append([0, 0, workdir + 'tneat -L -n 1024 -P ' + workdir + 'prop_sctp.json localhost'])
